...
mod tests {
    ...
    const EXAMPLE: &str = include_str!("test_resources/19-example.txt");
    const EXAMPLE_TWO: &str = include_str!("test_resources/19-example-2.txt");
    const MAIN: &str = include_str!("test_resources/19-main.txt");
